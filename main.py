...
model_path = 'model\BEST_checkpoint_coco_5_cap_per_img_5_min_word_freq.pth.tar'
word_map_path = 'model\WORDMAP_coco_5_cap_per_img_5_min_word_freq.json'
img_path = 'destination.png'
beam_size = 5
...
@app.get("/")
def home():
    return {"message":"Image Captioning Service is running, i think"}
